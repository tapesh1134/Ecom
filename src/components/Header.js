  ...
  return (
    <div className='z-50 w-full h-30 bg-white border-b-[1px] z-index-1 sticky top-0 border-b-gray-800 font-titleFont '>
      <div className='max-w-screen-xl h-full mx-auto flex items-center justify-between'>
       <Link to='/'>
          <div>
            <img src={'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSjjscR4xGI3nF1zwvQMVK4s6oACjxplg3P3g&usqp=CAU'} alt="LogoLight" className='w-28' />
          </div>
       </Link>
      <div className='flex gap-5 items-center'>
        <ul className='flex items-center gap-8 cursor-pointer'>
          <Link to={'/'}><li style={{color:"black", fontSize:"20px",paddingTop:"15px"}}>Home</li></Link>
        </ul>
